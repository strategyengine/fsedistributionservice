...
public class XrplController {
	...
	public List<FsePaymentResult> paymentTrustlines(
		...
		log.info("payment/trustlines: fromClassicAddress:{} fromSigningPublicKey:{} amount:{} issuerClassicAddress:{}" + paymentRequest.getFromClassicAddress(), paymentRequest.getFromSigningPublicKey(), paymentRequest.getAmount(), paymentRequest.getTrustlineIssuerClassicAddress());
	...
	public void paymentTrustlinesMinAirdrop(
		...
		//DO NOT LOG THE PRIVATE KEY!!
		log.info("payment/trustlines/min/airdrop: fromClassicAddress:{} fromSigningPublicKey:{} amount:{} issuerClassicAddress:{}" + paymentRequest.getTrustlinePaymentRequest().getFromClassicAddress(), paymentRequest.getTrustlinePaymentRequest().getFromSigningPublicKey(), paymentRequest.getTrustlinePaymentRequest().getAmount(), paymentRequest.getTrustlinePaymentRequest().getTrustlineIssuerClassicAddress());
